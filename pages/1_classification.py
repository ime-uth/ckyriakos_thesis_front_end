...
# ---------------------------------------
#oikonomaki_s2 = 'https://raw.githubusercontent.com/ckyriakos/Thesis--BI-through-ML-from-Satellite-Data/master/oik.csv'
...
def create_final_pandas(ts_pandas):
    ...
    ts_pandas=ts_pandas.drop(['IBI','VrNIRBI','PISI','EMBI','VgNIRBI'],axis=1)
